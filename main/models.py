...
class Product(models.Model):
    ...
    manufacturer = models.ForeignKey(Manufacturer, verbose_name='Производитель',  on_delete=models.CASCADE, blank=False, null=False)
    category = models.ForeignKey(Category, verbose_name='Категория',  on_delete=models.CASCADE)
    collection = models.ForeignKey(Collection, verbose_name='Коллекция', on_delete=models.CASCADE, blank=True, null=True)
...
class Specs(models.Model):
    ...
    unit = models.CharField('Ед. измерения', max_length = 10, choices = UNIT_CHOICES, blank=True, null=True)
